...
template <ggml_type type>
static bool should_use_small_k_impl(int c_ncols_dst, int ncols_x, int warp_size, int cc, mmvq_parameter_table_id table_id) {
    constexpr int qk  = ggml_cuda_type_traits<type>::qk;
    constexpr int qi  = ggml_cuda_type_traits<type>::qi;
    constexpr int vdr = get_vdr_mmvq(type);
    const int     blocks_per_row_x      = ncols_x / qk;
    ...
    static constexpr std::array<ggml_type, 2> iq_slow_turing = {
        GGML_TYPE_IQ3_XXS,
        GGML_TYPE_IQ3_S,
    };
    static constexpr std::array<ggml_type, 8> iq_slow_other = {
        GGML_TYPE_IQ1_S, GGML_TYPE_IQ1_M,   GGML_TYPE_IQ2_XXS, GGML_TYPE_IQ2_XS,
        GGML_TYPE_IQ2_S, GGML_TYPE_IQ3_XXS, GGML_TYPE_IQ3_S,   GGML_TYPE_IQ4_XS,
    };
    static constexpr std::array<ggml_type, 3> slow_pascal = {
        GGML_TYPE_IQ3_S,
        GGML_TYPE_Q2_K,
        GGML_TYPE_Q3_K,
    };
...
static void mul_mat_vec_q_switch_ncols_dst(
    ...
    switch (ncols_dst) {
        case 1: {
            ...
            bool use_small_k = should_use_small_k_impl<type>(c_ncols_dst, ncols_x, warp_size, cc, table_id);
