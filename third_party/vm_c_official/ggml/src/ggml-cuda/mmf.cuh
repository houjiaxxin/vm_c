...
bool ggml_cuda_should_use_mmf(enum ggml_type type, int device_id, int warp_size, const int64_t * src0_ne, const size_t * src0_nb, const int src1_ncols, bool mul_mat_id);
...
void mul_mat_f_cuda(
    ...
    const int nbytes_shared_iter = nwarps_best * (device_has_volta_mma(device) ? tile_A_32::I : tile_A_16::I) * (warp_size + mmf_get_padding(cc)) * 4;
