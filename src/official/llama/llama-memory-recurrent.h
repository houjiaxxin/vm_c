...
public:
    llama_memory_recurrent(
        ...
        const layer_filter_cb & filter,
                     int32_t   vm_c_tp_size = 1);

    uint32_t get_n_embd_r_row() const { return n_embd_r_row; }
    uint32_t get_n_embd_s_row() const { return n_embd_s_row; }
...
private:
    ...
    uint32_t n_embd_r_row = 0;
    uint32_t n_embd_s_row = 0;
